...
<body class="layout-login-centered-boxed" style="min-height:100%; background-attachment: fixed; background-repeat: no-repeat; background-size: cover; -moz-background-size: cover; background-image: linear-gradient(rgba(255, 255, 255, 0.975), rgba(255, 255, 255, 0.975)), url('{{ asset('assets/images/bg3.jpg') }}'); ">
    ...
    <div class="layout-login-centered-boxed__form">
        ...
        <div class="card card-body">
            ...
            <form action="{{ route('register') }}" method="POST">
                ...
                <div class="form-group">
                    <label class="text-label" for="password_confirmation">Password Confirmation:</label>
                    <div class="input-group input-group-merge">
                        <input id="password_confirmation" name="password_confirmation" type="password" required="" class="form-control form-control-prepended" placeholder="Enter your password confirmation">
                        <div class="input-group-prepend">
                            <div class="input-group-text">
                                <span class="fa fa-key"></span>
                            </div>
                ...
                <div class="form-group">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="role" id="restaurant_manager" value="restaurant_manager">
                        <label class="form-check-label" for="restaurant_manager">Restaurant Manager</label>
                    </div>
                    <div id="restaurant-div" class="d-none pt-4 pl-2">
                        <div class="form-group">
                            <label class="text-label" for="restaurant_name">Restaurant Name:</label>
                            <div class="input-group input-group-merge">
                                <input id="restaurant_name" name="restaurant_name" type="text" required="" class="form-control form-control-prepended" placeholder="Enter your restaurant name">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="text-label" for="restaurant_description">Restaurant Description:</label>
                            <div class="input-group input-group-merge">
                                <textarea class="form-control form-control-prepended" name="restaurant_description" id="restaurant_description" cols="30" rows="5" required></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="text-label" for="restaurant_category">Restaurant Category:</label>
                            <div class="input-group input-group-merge">
                                <select class="form-control" id="restaurant_category" name="restaurant_category" aria-label="Default select example">
    ...
    <script>
        $('#restaurant_manager').on('input', function () {
            $('#restaurant-div').removeClass('d-none');
        });

        $('#customer').on('input', function () {
            $('#restaurant-div').addClass('d-none');
        });
    </script>
